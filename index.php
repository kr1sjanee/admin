...
<body>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link logo-switch">
            <img src="img/krisjane.jpg" alt="AdminLTE Docs Logo Small" class="brand-image-xl logo-xs">
            <img src="img/krisjane.jpg" alt="AdminLTE Docs Logo Large" class="brand-image-xs logo-xl" style="left: 12px">
        </a>
